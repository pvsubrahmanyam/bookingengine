...
function getRoompool1(str)
{
    ...
    xmlhttp.open("GET","wp_roompool_ajax.php?id="+str,true);
    xmlhttp.send();
...
getRoompool("wp_roompool_ajax.php?id="+strUser);
...
<div id="select_box">
<select id="ddlViewBy" onchange="getRoompool1(this.value)" class="select_1" >
...
<li class="active"> <a href="roompools.php">Room pols</a></li>
